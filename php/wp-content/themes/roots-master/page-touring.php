<?php
/*
Template Name: Page Touring Template
*/
?>
<div class="container">
	<div class="row">
		<div class="span8">
			...
			<div class="well">
				<p>
					<iframe src="https://www.google.com/maps/d/embed?mid=1TehF9aSa-gwL13_nix3bT4Xc0hU" width="100%" height="480"></iframe> 
				</p>
				<p>
					<b>MCO Touring</b> 
				</p>
...
<!-- /well -->
			<div>
				...
				<p><small>Some of these projects were funded in part by FACTOR, the Government of Canada and Canada&rsquo;s private radio broadcasters.</small></p>
				<p><small>Certains de ces projets ont &eacute;t&eacute; financ&eacute;s en partie par FACTOR, le gouvernement du Canada et les radiodiffuseurs prive&#x301;s du Canada.</small></p>
				<p>&nbsp;</p>
			</div>
		</div>
	</div>
<!-- /row -->
<?php get_template_part('templates/content', 'touring'); ?>
</div>
<!-- /container -->
<script>
