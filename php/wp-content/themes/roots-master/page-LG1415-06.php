...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="span7">
      ...
      <p>
      <span class="badge">2</span>&nbsp;What <b>Instruments</b> can you hear in this concerto? How many performers are playing onstage? What string instruments do you hear (violin, viola, cello, double bass)? Can you pick out when you hear the flute, oboes, bassoons, and horns?
      </p>
      ...
      <p>
      <span class="badge">3</span>&nbsp;Can you identify the mood Beethoven is trying to create in each movement? How does Beethoven use tempo (the speed of the music), dynamics (the volume of the music), and expression (musical elements that express certain feelings or dispositions) to create different moods? 
      </p>
      ...
      <p>
      <span class="badge">5</span>&nbsp;How is <b>melody or pitch</b> used in this piano concerto? Do you hear high sounds or pitches? Do you hear low sounds or pitches? Can you pick out a particular melody played by the orchestra instruments or piano in each of the three movements? Can you hum or sing that melody? Could you draw the shape of the melody in the air? When does it move up higher and when does it move lower? 
      </p>
      ...
      <p>
      <span class="badge">6</span>&nbsp;Can you hear different kinds of texture in this work? Where do you hear lots of instruments playing together so that the sound is thick? Where do you hear just a few instruments playing? Can you tell which instruments are playing?
      </p>

      <p>
      <span class="badge">7</span>&nbsp;What kinds of instrumental timbre do you hear? Timbre is the different qualities of sound that can be heard, for example the kinds of sounds that the string instruments make when they play together. When does the timbre of the music change because Beethoven adds different instruments to the strings? Can you hear when the strings are playing alone and when they are playing together with the piano and other instruments?
      </p>
      ...
      <p>
      <span class="badge">1</span>&nbsp;What is your immediate response to this music? Does this music sound like any other music you have heard before? What does this music make you think of? Have you ever heard the opening of Beethoven&rsquo;s fifth symphony? It has a famous four note opening that is often used in films and on TV. If you have ever heard Beethoven&rsquo;s fifth, does it sound anything like his second piano concerto? What music elements might be similar? 
      </p>
      ...
      <p>
      <span class="badge">3</span>&nbsp;What musical elements did you enjoy or find interesting? Did you enjoy the melodies that you heard? Did the rhythms, dynamics, or tempos used by Beethoven help make this work exciting? Did you hear parts of the piano concerto that made you feel peaceful or calm and if so, what part of the piano concerto were they in? Were there any parts that sounded playful to you? If so, which movement did you hear them in?
      </p>
      ...
      <p>
      <span class="badge">5</span>&nbsp;Different people often have different responses to the same music. Ask someone else who heard the same music about their response to BeethovenÕs second piano concerto. 
      </p>
      ...
      <p>
      <span class="badge">7</span>&nbsp;Is there other music by Beethoven that you could listen to and compare to the sounds and experience of the Piano Concerto No. 2? 
      </p>
      ...
      <p>
      <span class="badge">1</span>&nbsp;Can you identify the form (organizational structure) of this symphony? 
      </p>
      ...
      <p>
      <span class="badge">2</span>&nbsp;What <b>instruments</b> can you hear in this symphony? How many performers are playing onstage? What string instruments do you hear (violin, viola, cello, double bass)? Can you pick out other instruments? Which ones?
      </p>

      <p>
      <span class="badge">3</span>&nbsp;Can you identify the mood Mozart is trying to create in each movement? How does Mozart use <b>tempo</b> (the speed of the music), <b>dynamics</b> (the volume of the music), and <b>expression</b> (musical elements that express certain feelings or dispositions) to create different moods? 
      </p>
      ...
      <p>
      <span class="badge">4</span>&nbsp;How is <b>rhythm</b> used in this symphony? Do you hear sections that have a steady rhythm or beat that you could tap to? 
      </p>
      ...
      <p>
      <span class="badge">5</span>&nbsp;How is <b>melody</b> used in this symphony? Do you hear high sounds or pitches? Do you hear low sounds or pitches? Can you hear when a melody suddenly jumps much higher? The opening of the first movement is sometimes known as the rocket theme because in the opening rhythmic pattern &lsquo;open up open up now,&rsquo; the note on the word &lsquo;now&rsquo; is suddenly higher than the rest. 
      </p>

      <p>
      There is another rocket sound at the very beginning of the fourth movement that Mozart creates by writing a series of notes that quickly go higher and higher. This was known as a &lsquo;Mannheim rocket.&rsquo; Can you hear the Mannheim rocket in the finale of Mozart&rsquo;s symphony?
      </p>
      ...
      <p>
      <span class="badge">6</span>&nbsp;Can you hear different kinds of <b>texture</b> in this work? Where do you hear lots of instruments playing together so that the sound is thick? Where do you hear just a few instruments playing? Can you hear which instruments are playing?
      </p>

      <p>
      <span class="badge">7</span>&nbsp;What kinds of instrumental <b>timbre</b> do you hear? Timbre is the different qualities of sound that can be heard, for example the kinds of sounds that the string instruments make when they play together. When does the timbre of the music change because Mozart adds or takes away different instruments? 
      </p>
      ...
      <p>
      <span class="badge">2</span>&nbsp;What adjectives might describe the mood that you felt when listening to this symphony? Can you identify what musical elements may have created that mood for you? When did the mood change and why?
      </p>

      <p>
      <span class="badge">3</span>&nbsp;What musical elements did you enjoy or find interesting? Did you enjoy the melodies that you heard? Did the rhythms, dynamics, or tempos used by Mozart help make this work exciting? Did you hear parts of the symphony that made you feel peaceful or calm and if so, what part of the symphony were they in? Were there any parts that sounded particularly dramatic to you? If so, which movement did you hear them in and why did they feel dramatic to you?
      </p>

      <p>
      <span class="badge">4</span>&nbsp;Were there parts of the Symphony that you did not enjoy? Why or why not? Can you identify which music elements made you enjoy or not enjoy the music?
      </p>

      <p>
      <span class="badge">5</span>&nbsp;Different people often have different responses to the same music. Ask someone else who heard the same music about their response to Mozart&rsquo;s Symphony No. 40.
      </p>
      ...
      <p>
      <span class="badge">7</span>&nbsp;Is there other music by Mozart that you could listen to and compare to the sounds and experience of the Symphony No. 40? 
      </p>
