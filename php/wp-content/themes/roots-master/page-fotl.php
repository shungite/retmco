<?php
/*
Template Name: Page FOTL Template
*/
?>
<div class="container">
	<div class="row">
		<div class="span8">
			<img src="http://www.themco.ca/wp-content/uploads/2016/09/FOTL.jpg" alt="Fiddlers on the loose!" width="770" height="455"> 
		</div>
	</div>
<!-- /row -->
	<div class="row">
		<div class="span8">
			...
			<p>
				The musicians who comprise our group bring to bear the rigour and experience of internationally trained professionals who&rsquo;ve spent years developing their craft. 
			</p>
			<p>
			...
			<p>
				Accordingly, our approach is as collaborative as it is instructive: we have a blast performing and sharing fiddle tunes with students in community and school settings, while also offering technical and professional advice about musicianship. We work closely with music teachers and fiddle instructors, and they have commented on the program&rsquo;s impact beyond the classroom. 
			</p>
			<p>
...
<!-- /row -->
<?php get_template_part('templates/content', 'fotl'); ?>
</div>
<!-- /container -->
