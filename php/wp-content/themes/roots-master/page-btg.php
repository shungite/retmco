...
<div class="row">
	...
	<div class="span7">
		...
		<p>Manitoba Chamber Orchestra<br>
			and the Pembina Trails Voices Anne Manson, Conductor<br>
			Ruth Wiwchar, Director of the Pembina Trails Voices<br>
			Donna Fletcher, Director</p>
		<p>Performances March 12, 2013:<br>
		...
		<dl>
			...
			<dt>About Brundib&aacute;r</dt>
			<dd>Cast</dd>
			<dd>Synopsis</dd>
			<dt>Before going to Brundib&aacute;r</dt>
			<dd>Connect and motivate</dd>
			<dd>Audience Etiquette</dd>
			<dt>During the performance</dt>
			<dd>Look</dd>
			<dd>Listen<dd>
			<dd>Think</dd>
			<dt>After attending Brundib&aacute;r</dt>
			<dd>React</dd>
			<dd>Retell</dd>
			<dd>Write something original</dd>
			<dd>Research</dd>
			<dt>Curricular connections</dt>
			<dd>Aesthetics and art criticism</dd>
			<dd>English, reading and writing</dd>
	...
	<table class="table table-striped">
		...
		<tr>
			<td>1899</td>
			<td>Born on November 30 in Prague</td>
			<td>May 10, Fred Astaire born<br>July 21, Ernest Hemingway born</td>
		</tr>
		<tr>
			<td>1921</td>
			<td>Graduates from the German Music Academy in Prague</td>
			<td>July 29, Hitler becomes leader of the Nazi party</td>
		</tr>
		<tr>
			<td>1933</td>
		...
		<tr>
			<td>1939</td>
			<td>&nbsp;</td>
			<td>Nazis seize control of Czechoslovakia</td>
		</tr>
			<tr>
			<td>1941</td>
			...
			<tr>
			<td>1943</td>
			<td>September 23, <em>Brundib&aacute;r</em> performed for first time in Terezin</td>
			<td>January 18, Warsaw Ghetto Uprising begins</td>
		</tr>
			<tr>
			<td>1944</td>
	...
	<p>About <em>Brundib&aacute;r</em></p>
	...
	<dl>
		...
		<dt>Ice cream seller</dt>
		<dd>Alexandra Skwarchuk &mdash; Chorale</dd>
		<dt>Baker</dt>
		<dd>David Newell &mdash; PTV Boys</dd>
		<dt>Milkman</dt>
		<dd>Matthew Woelk &mdash; PTV Boys</dd>
		<dt>Policewoman</dt>
		<dd>Rachel Woelk &mdash; Cantemus</dd>
		<dt>Sparrow</dt>
		<dd>Jane Petroff &mdash; Cantemus</dd>
		<dt>Cat</dt>
		<dd>Tessa Jenkyns &mdash; Cantemus</dd>
		<dt>Dog</dt>
	...
	<p>Discuss</p>
	<ul>
		<li>What do you know about the story of <em>Brundib&aacute;r</em>? What do you think is the point of  the story?</li>
		<li>What is a tyrant? Do you know any tyrants?</li>
		<li>What do you think the opera will be like?</li>
	</ul>
	<p><b>Audience etiquette</b></p>
	<p>Discuss</p>
	<ul>
		<li>Is it all right to laugh? Cry?</li>
		<li>Is it all right to applaud? When?</li>
	</ul>
	<p><b>Read the background information</b>
	<p>Discuss life in Europe during the Second World War</p>
	<ul>
		<li>How did life differ from the times in which we now live?</li>
		<li>How do you think the times may have inspired the story of the opera?</li>
	</ul>
	<h4>During the performance</h4>
	<p><b>Look</b></p>
	<p>What do you see? Notice the following:</p>
	<ul>
		<li>Sets and props</li>
		<li>Costumes</li>
		<li>Movement/choreography</li>
	</ul>
	<p><b>Listen</b></p>
		<ul>
			<li>How does each scene begin?</li>
			<li>What arias or other songs are sung?</li>
			<li>How does the music change the mood?</li>
		</ul>
	<p><b>Think</b></p>
	<ul>
		<li>What problems arise in the opera?</li>
		<li>How are the problems solved?</li>
	</ul>
	<h4>After the performance</h4>
	<p><b>React to the experience</b></p>
	<p>Write or talk about the following</p>
	<ul>
		<li>Did you like the opera? Why or why not?</li>
		<li>What did you like the best or least?</li>
		<li>What character(s) did you like the best or least?</li>
		<li>Sets/costumes/props</li>
	</ul>
	<p><b>Retell the story</b></p>
	<p>Write something original</p>
	<ul>
		<li>Write a song for one of the characters in the opera</li>
		<li>Write a song for a fairytale character</li>
		<li>Write a story, song, poem or skit with ideas from the opera, such as</li>
			<ul>
		...
		<p><b>Research</b></p>
		<p>Find out more about one of the following</p>
		<ul>
			<li>Terezin, Czech Republic</li>
			<li>Fairytales</li>
			<li>Hans Krasa</li>
			<li>Surviving cast members, such as Ella Weissberger &mdash; the original Cat</li>
		</ul>
		<h4>Curricular connections</h4>
		<p><b>Aesthetics and art criticism</b></p>
		<ul>
			<li>After reviewing the Study Guide and attending the Manitoba Chamber Orchestra&rsquo;s production of <em>Brundib&aacute;r</em>, ask students to write a review of the production, noting how the music directly affects the emotional impact for the listener.</li>
		</ul>
		<p><b>English, reading and writing</b></p>
		<ul>
			<li>After seeing the Manitoba Chamber Orchestra&rsquo;s production of <em>Brundib&aacute;r</em>, ask students to write a journal entry or review of the show as a reflection.</li>
			<li>Write a sequel to <em>Brundib&aacute;r</em> about what happens to the characters or life in the town 5 years after the action in opera.</li>
			<li>Using persuasive writing styles, create a new ending for the opera, using known character information to produce absolute change within one or more of the characters.</li>
			<li>Ask the students to consider whether there are other stories that remind them of <em>Brundib&aacute;r</em>. Ask the students to choose a fairytale and write an opera libretto. Remind them that they may have to streamline and/or simplify the story. It takes longer to sing something than to say it. The libretto will consist almost entirely of  dialogue. After they have written the libretto, have them reflect on what they had to do to take a written story and make it work as a dramatic or musical one. They  can use poetry or not, as they wish.</li>
		</ul>
		<p><b>Science</b></p>
		<p>The voice is a combination of a wind instrument and a string instrument &mdash; air passing  through the vocal cords creates a vacuum, pulling the vocal cords closed, The cords then vibrate together and create sound. Pitch is determined by the tension of the vocal cords, just like a violin or guitar. You can demonstrate this with a rubber band: wrap a rubber  band around your fingers. Pluck it a few times. Can you see and feel the vibrations? The harder you pluck the rubber band, the more it will vibrate, creating a louder sound. If you stretch the rubber band, making it longer and thinner, what do you hear? (It will be a higher pitch.) Have your students place their hands on their throats while speaking or singing at different pitches so they can feel the vibrations in their throats and chests. Explore sound waves.</p>
		<p><b>Create, present, perform</b></p>
		<ul>
			<li>Obtain copies of the translation of the libretto for <em>Brundib&aacute;r</em>. Have students read the parts in a dramatic reading, infusing as much feeling and power into the words as possible. The language may be awkward or embarrassing. Ask them to translate the libretto into their own way of speaking and perform that way. Then return to  the original libretto. How does their perception of the language change &mdash; or not? Do they think that music can affect how the lines sound?</li>
			<li>Have students work in groups to write their own &lsquo;operas&rsquo; using popular songs, stringing them together with dialogue. These could be performed for the class.</li>
		</ul>
	</div>
